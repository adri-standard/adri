...
class TestVerodatLogger:
    ...
    def test_build_verodat_header_from_standard(self, verodat_config, mock_assessment_logs_standard):
    ...
    def test_format_audit_record_to_verodat_row(self, verodat_config, sample_audit_record, mock_assessment_logs_standard):
        ...
        row = logger._format_record_to_row(sample_audit_record, mock_assessment_logs_standard, 'assessment_logs')
    ...
    def test_format_dimension_scores(self, verodat_config, sample_audit_record, mock_dimension_scores_standard):
        ...
        rows = logger._format_dimension_scores(sample_audit_record, mock_dimension_scores_standard)
        ...
        assert first_row[1] in ["completeness", "validity", "consistency", "uniqueness"]  # dimension_name
        assert isinstance(first_row[2], float)  # dimension_score
        assert first_row[3] in ["TRUE", "FALSE"]  # dimension_passed

    def test_prepare_verodat_payload(self, verodat_config, sample_audit_record, mock_assessment_logs_standard):
    ...
    @patch('requests.post')
    def test_upload_to_verodat_success(self, mock_post, verodat_config, sample_audit_record):
    ...
    @patch('requests.post')
    def test_upload_to_verodat_failure_with_retry(self, mock_post, verodat_config, sample_audit_record):
    ...
    @patch('requests.post')
    def test_upload_failure_after_max_retries(self, mock_post, verodat_config, sample_audit_record):
