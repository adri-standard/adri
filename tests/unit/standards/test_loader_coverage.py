...
from adri.standards.loader import StandardsLoader, load_bundled_standard, list_bundled_standards
...
class TestStandardsLoaderCoverage:
    ...
    def test_fallback_to_adri_folder_path(self):
        ...
        with patch.object(StandardsLoader, '_get_standards_path', mock_get_standards_path):
    ...
    def test_validate_standard_structure_missing_standards_field(self):
        ...
        assert "Missing required field in standards section: version" in str(exc_info.value)
    ...
    def test_validate_standard_structure_missing_overall_minimum(self):
        ...
        assert "Missing 'overall_minimum' in requirements section" in str(exc_info.value)
    ...
    def test_list_bundled_standards_convenience_function(self):
        ...
        with patch.object(StandardsLoader, 'list_available_standards', return_value=mock_standards):
    ...
    def test_get_standard_metadata_with_defaults(self):
        ...
        with patch.object(loader, 'standard_exists', return_value=True), \
