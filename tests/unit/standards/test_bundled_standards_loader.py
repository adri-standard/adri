...
from adri.standards.exceptions import StandardNotFoundError, InvalidStandardError
...
class TestBundledStandardsLoader:
    ...
    def test_load_financial_data_standard(self):
        ...
        standard = self.loader.load_standard("financial_risk_analyzer_financial_data_standard")
