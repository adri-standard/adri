...
"""
            ...
            with patch("pathlib.Path.cwd", return_value=temp_path):
                ...
                with patch(
                    "adri.standards.yaml_standards.__file__",
                    str(temp_path / "fake_module.py"),
                ):
                    ...
                    assert (
                        yaml_standards.standard_data["standards"]["id"]
                        == "test_standard"
                    )
    ...
    def test_check_compliance_with_dimension_score_dict(self):
        ...
        standard_content = {
            ...
            "requirements": {
                ...
                "dimension_requirements": {"validity": 80.0, "completeness": 85.0},
            },
        }
