...
class TestBundledStandardWrapper:
    ...
    def test_get_field_requirements(self):
        ...
        standard_dict = {
            "requirements": {
                "field_requirements": {"name": {"type": "string"}, "age": {"type": "integer"}}
            }
        }
        wrapper = BundledStandardWrapper(standard_dict)
...
class TestAssessmentResult:
    ...
    def test_to_v2_standard_dict_with_all_data(self):
        ...
        dimension_scores = {"validity": DimensionScore(18.0), "completeness": DimensionScore(19.0)}
        result = AssessmentResult(85.0, True, dimension_scores, "test_standard", datetime.now())
