...
class TestAdriProtectedDecorator(unittest.TestCase):
    ...
    def test_basic_decorator_usage(self, mock_engine_class, mock_config_manager):
        ...
        mock_manager.get_protection_config.return_value = self.mock_config['adri']['protection']
    ...
    @patch('adri.decorators.guard.ConfigManager')
    @patch('adri.decorators.guard.DataProtectionEngine')
    def test_decorator_with_explicit_standard_file(self, mock_engine_class, mock_config_manager):
    ...
    @patch('adri.decorators.guard.ConfigManager')
    @patch('adri.decorators.guard.DataProtectionEngine')
    def test_decorator_with_custom_parameters(self, mock_engine_class, mock_config_manager):
        ...
        self.assertEqual(call_args[1]['dimensions'], {"validity": 19, "completeness": 18})
    
    @patch('adri.decorators.guard.ConfigManager')
    @patch('adri.decorators.guard.DataProtectionEngine')
    def test_decorator_quality_failure_raises_exception(self, mock_engine_class, mock_config_manager):
        ...
        mock_engine = MagicMock()
        mock_engine.protect_function_call.side_effect = ProtectionError("Data quality insufficient")
        mock_engine_class.return_value = mock_engine
    ...
    @patch('adri.decorators.guard.ConfigManager')
    @patch('adri.decorators.guard.DataProtectionEngine')
    def test_decorator_missing_data_parameter(self, mock_engine_class, mock_config_manager):
        ...
        mock_engine = MagicMock()
        mock_engine.protect_function_call.side_effect = ValueError("Could not find data parameter 'missing_param'")
        mock_engine_class.return_value = mock_engine
...
class TestDataProtectionEngine(unittest.TestCase):
    ...
    def test_resolve_standard_with_explicit_file(self, mock_config_manager):
        ...
        mock_manager = MagicMock()
        mock_manager.get_protection_config.return_value = self.mock_config['adri']['protection']
        mock_manager.resolve_standard_path_simple.return_value = "/path/to/custom_standard.yaml"
        mock_config_manager.return_value = mock_manager
        ...
        mock_manager.resolve_standard_path_simple.assert_called_once_with("custom_standard.yaml")
    ...
    def test_resolve_standard_with_auto_generation(self, mock_config_manager):
        ...
        mock_manager = MagicMock()
        mock_manager.get_protection_config.return_value = self.mock_config['adri']['protection']
        mock_manager.resolve_standard_path_simple.return_value = "/path/to/test_func_data_standard.yaml"
        mock_config_manager.return_value = mock_manager
        ...
        mock_manager.resolve_standard_path_simple.assert_called_once_with("test_func_data_standard.yaml")
    
    @patch('adri.core.protection.ConfigManager')
    @patch('adri.core.protection.StandardGenerator')
    def test_ensure_standard_exists_generates_when_missing(self, mock_generator_class, mock_config_manager):
    ...
    def test_assess_data_quality_success(self, mock_assessor_class, mock_config_manager):
    ...
    @patch('adri.core.protection.StandardGenerator')
    @patch('adri.core.protection.AssessmentEngine')
    def test_protect_function_call_full_workflow(self, mock_assessor_class, mock_generator_class, mock_config_manager):
        """Test complete protection workflow."""
        # Setup mocks
        mock_manager = MagicMock()
        mock_manager.get_protection_config.return_value = self.mock_config['adri']['protection']
        mock_manager.resolve_standard_path_simple.return_value = os.path.join(self.standards_dir, "test_standard.yaml")
        mock_config_manager.return_value = mock_manager
