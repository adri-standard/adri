...
class TestValidateStandardCommand(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.valid_standard_path = self.test_dir / "examples" / "standards" / "test_standard.yaml"
        self.invalid_standard_path = self.test_dir / "examples" / "standards" / "invalid_standard.yaml"
