...
class TestValidateYamlStandardEdgeCases:
    ...
    def test_validate_yaml_standard_invalid_yaml(self, mock_yaml_load, mock_file, mock_exists):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('adri.cli.commands.yaml.safe_load')
    def test_validate_yaml_standard_not_dict(self, mock_yaml_load, mock_file, mock_exists):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('adri.cli.commands.yaml.safe_load')
    def test_validate_yaml_standard_missing_sections(self, mock_yaml_load, mock_file, mock_exists):
    ...
    def test_validate_yaml_standard_yaml_standards_failure(self, mock_yaml_standards, mock_yaml_load, mock_file, mock_exists):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('adri.cli.commands.yaml.safe_load')
    def test_validate_yaml_standard_unexpected_error(self, mock_yaml_load, mock_file, mock_exists):
...
class TestValidationHelperFunctions:
    ...
    def test_validate_standards_metadata_missing_fields(self):
        ...
        standards_section = {"name": "Test", "version": "1.0.0"}  # Missing id and authority
    ...
    def test_validate_standards_metadata_empty_values(self):
        ...
        assert result["is_valid"] is False
        assert any("Empty value for required field" in error for error in result["errors"])
    ...
    def test_validate_dimension_requirements_out_of_range_minimum_score(self):
        ...
        assert result["is_valid"] is False
        assert "minimum_score for validity must be between 0 and 20" in result["errors"][0]
    ...
    def test_validate_field_requirements_field_config_not_dict(self):
        ...
        assert result["is_valid"] is False
        assert "Field 'field1' configuration must be a dictionary" in result["errors"][0]
    ...
    def test_validate_field_requirements_invalid_nullable(self):
        ...
        assert result["is_valid"] is False
        assert "nullable for field 'field1' must be true or false" in result["errors"][0]
    ...
    def test_validate_field_requirements_invalid_min_max_range(self):
        ...
        assert result["is_valid"] is False
        assert "min_value must be less than max_value for field 'field1'" in result["errors"][0]
...
class TestShowConfigCommandEdgeCases:
    ...
    def test_show_config_invalid_config(self, mock_config_manager):
        ...
        mock_config_manager_instance = MagicMock()
        mock_config_manager.return_value = mock_config_manager_instance
        mock_config_manager_instance.get_active_config.return_value = {"invalid": "config"}
...
class TestListCommandsEdgeCases:
    ...
    def test_list_training_data_invalid_environment(self, mock_config_manager):
        ...
        mock_config_manager.return_value = mock_config_manager_instance
        mock_config_manager_instance.get_active_config.return_value = {"test": "config"}
        mock_config_manager_instance.get_environment_config.side_effect = ValueError("Invalid environment")
...
class TestExportReportEdgeCases:
    ...
    def test_export_report_unsupported_format(self, mock_datetime, mock_json_load, mock_file, 
