...
class TestCrewAILive:
    ...
    def test_crewai_market_analysis_with_good_data(self, good_market_data):
        ...
        try:
            ...
            expected_fields = ['client_id', 'market_segment', 'analysis_period', 'status']
            ...
            assert result.get('market_segment') == good_market_data['market_segment'], "Should match input segment"
    ...
    def test_crewai_customer_support_crew_live(self):
        ...
        try:
            ...
            if hasattr(module, 'crewai_customer_support_crew'):
                ...
                assert result.get('ticket_id') == support_data['ticket_id'], "Should match ticket ID"
                
                print(f"✅ CrewAI customer support crew test passed")
                print(f"   Ticket: {result.get('ticket_id', 'N/A')}")
                print(f"   Status: {result.get('status', 'N/A')}")
            else:
                pytest.skip("crewai_customer_support_crew function not found in example")
    ...
    def test_crewai_content_creation_crew_live(self):
        ...
        try:
            ...
            if hasattr(module, 'crewai_content_creation_crew'):
                ...
                assert isinstance(result, dict), "Result should be dictionary"
                assert result.get('type') == content_data['content_type'], "Should match content type"
                ...
                pytest.skip("crewai_content_creation_crew function not found in example")
