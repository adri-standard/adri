...
class TestAutoGenLive:
    ...
    def test_autogen_research_collaboration_with_good_data(self, good_research_data):
        ...
        try:
            ...
            assert (
                result.get("topic") == good_research_data["research_topic"]
            ), "Should match input topic"
    ...
    def test_autogen_coding_collaboration_live(self):
        ...
        try:
            ...
            if hasattr(module, "autogen_coding_collaboration"):
                ...
                assert (
                    result.get("project_name") == coding_data["project_name"]
                ...
                pytest.skip(
                    "autogen_coding_collaboration function not found in example"
                )
    ...
    def test_autogen_problem_solving_team_live(self):
        ...
        try:
            ...
            if hasattr(module, "autogen_problem_solving_team"):
                ...
                assert isinstance(result, dict), "Result should be dictionary"
                assert (
                    result.get("problem_title") == problem_data["problem_title"]
                ), "Should match problem title"
                ...
                pytest.skip(
                    "autogen_problem_solving_team function not found in example"
                )
