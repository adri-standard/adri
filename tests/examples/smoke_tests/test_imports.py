...
class TestFrameworkImports:
    ...
    def test_semantic_kernel_example_imports(self, examples_directory):
        ...
        spec = importlib.util.spec_from_file_location("semantic_kernel_example", example_file)
        assert spec is not None, "Could not create module spec"
    ...
    def test_examples_have_shebang(self):
        ...
        for filename in example_files:
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                assert 'python' in first_line.lower(), f"{filename} should have Python shebang"
    ...
    def test_examples_have_docstrings(self):
        ...
        for filename in example_files:
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                assert framework_name.lower() in content.lower(), f"{filename} should mention {framework_name}"
    ...
    def test_examples_have_api_key_checks(self):
        ...
        for filename in example_files:
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                assert 'OPENAI_API_KEY' in content, f"{filename} should check for OPENAI_API_KEY"
                
                # Should have error handling for missing key
                assert 'sys.exit' in content or 'exit(' in content, f"{filename} should exit when no API key"
