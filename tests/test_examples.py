...
class TestLangChainExamples(TestFrameworkExamples):
    ...
    def test_langchain_basic_example_exists(self):
        ...
        assert hasattr(module, 'customer_service_agent'), "Should have customer_service_agent function"
        assert hasattr(module.customer_service_agent, '__wrapped__'), "Function should be decorated"
...
class TestCrewAIExamples(TestFrameworkExamples):
    ...
    def test_crewai_basic_example_exists(self):
        ...
        assert hasattr(module, 'market_analysis_crew'), "Should have market_analysis_crew function"
        assert hasattr(module.market_analysis_crew, '__wrapped__'), "Function should be decorated"
...
class TestAutoGenExamples(TestFrameworkExamples):
    ...
    def test_autogen_basic_example_exists(self):
        ...
        assert hasattr(module, 'multi_agent_conversation'), "Should have multi_agent_conversation function"
        assert hasattr(module.multi_agent_conversation, '__wrapped__'), "Function should be decorated"
...
class TestLlamaIndexExamples(TestFrameworkExamples):
    ...
    def test_llamaindex_basic_example_exists(self):
        ...
        assert hasattr(module, 'rag_query_engine'), "Should have rag_query_engine function"
        assert hasattr(module.rag_query_engine, '__wrapped__'), "Function should be decorated"
...
class TestHaystackExamples(TestFrameworkExamples):
    ...
    def test_haystack_basic_example_exists(self):
        ...
        assert hasattr(module, 'document_search_pipeline'), "Should have document_search_pipeline function"
        assert hasattr(module.document_search_pipeline, '__wrapped__'), "Function should be decorated"
...
class TestSemanticKernelExamples(TestFrameworkExamples):
    ...
    def test_semantic_kernel_basic_example_exists(self):
        ...
        spec = importlib.util.spec_from_file_location("semantic_kernel_basic", example_file)
        module = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(module)
        
        assert hasattr(module, 'kernel_function'), "Should have kernel_function function"
        assert hasattr(module.kernel_function, '__wrapped__'), "Function should be decorated"
...
class TestLangGraphExamples(TestFrameworkExamples):
    ...
    def test_langgraph_basic_example_exists(self):
        ...
        assert hasattr(module.graph_workflow, '__wrapped__'), "Function should be decorated"
...
class TestGenericExamples(TestFrameworkExamples):
    ...
    def test_generic_basic_example_exists(self):
        ...
        assert hasattr(module.data_processor, '__wrapped__'), "Function should be decorated"
...
class TestExamplesREADME:
    ...
    def test_examples_readme_has_all_frameworks(self):
        ...
        frameworks = [
            ...
            'haystack', 'semantic_kernel', 'langgraph', 'generic'
        ]
        
        for framework in frameworks:
            assert framework.lower() in content.lower(), f"README should mention {framework}"
