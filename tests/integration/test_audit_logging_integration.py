...
""")
    ...
    def test_protection_engine_creates_audit_log(self, mock_audit_logger_class, 
                                                  temp_audit_log, temp_standard_file, 
                                                  sample_data):
    ...
    def test_end_to_end_audit_trail(self, temp_audit_log, temp_standard_file, sample_data):
    ...
    def test_failed_assessment_audit_trail(self, temp_audit_log, temp_standard_file):
        ...
        with patch('adri.config.manager.ConfigManager.get_audit_config') as mock_config:
            ...
            if not exception_raised:
                ...
                assert os.path.exists(temp_audit_log), "Audit log should be created even on failure"
