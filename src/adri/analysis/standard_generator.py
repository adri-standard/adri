...
class StandardGenerator:
    ...
    def _generate_requirements(self, data_profile: Dict[str, Any], thresholds: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_single_field_requirement(self, field_profile: Dict[str, Any]) -> Dict[str, Any]:
