...
ADRI_ASSESSMENT_REPORT_TEMPLATE_V0_1_0 = {
    ...
    "field_requirements": {
        ...
        "adri_assessment_report": {
            ...
            "required_fields": ["metadata", "summary", "rule_execution_log", "field_analysis"]
        },
        ...
        "metadata": {
            ...
            "required_fields": ["assessment_id", "timestamp", "adri_version", "standard_applied", "dataset", "execution"]
        },
        ...
        "summary": {
            ...
            "required_fields": ["overall_score", "dimension_scores", "pass_fail_status"]
        },
        ...
        "summary.dimension_scores": {
            ...
            "required_fields": ["validity", "completeness", "consistency", "freshness", "plausibility"]
        },
        ...
        "summary.pass_fail_status": {
            ...
            "required_fields": ["overall_passed", "failed_dimensions", "critical_issues", "total_failures"]
        },
