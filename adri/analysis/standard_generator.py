...
class StandardGenerator:
    ...
    def generate_standard(
        ...
        standard = {
            ...
            'requirements': self._generate_requirements(data_profile, generation_config),
    ...
    def _generate_requirements(
        ...
        return {
            'overall_minimum': self._calculate_overall_minimum(data_profile, thresholds),
    ...
    def _calculate_overall_minimum(
        ...
        nullable_ratio = sum(1 for field in fields.values() if field.get('nullable', False)) / max(len(fields), 1)
    ...
    def _generate_dimension_requirements(self, thresholds: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            'validity': {
                'minimum_score': percentage_to_score(thresholds.get('validity_min', 90)),
                'description': "Data must conform to expected formats and constraints"
            },
            'completeness': {
                'minimum_score': percentage_to_score(thresholds.get('completeness_min', 85)),
                'description': "Required fields must be populated"
            },
            'consistency': {
                'minimum_score': percentage_to_score(thresholds.get('consistency_min', 80)),
    ...
    def _generate_field_requirements(self, data_profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_integer_constraints(self, field_profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_float_constraints(self, field_profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_string_constraints(self, field_profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_date_constraints(self, field_profile: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_metadata(self, data_name: str, data_profile: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if any('balance' in name.lower() or 'amount' in name.lower() for name in field_names):
            tags.append('financial')
        if any('date' in name.lower() or 'time' in name.lower() for name in field_names):
