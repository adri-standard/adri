...
class CrewAIProblems:
    ...
    CREW_COORDINATION_GOOD = {
        ...
        "tasks": [
            {"id": "task_001", "description": "Collect Q4 market data", "assigned_to": "market_researcher"},
            {"id": "task_002", "description": "Analyze data trends", "assigned_to": "data_analyst"},
            {"id": "task_003", "description": "Write executive report", "assigned_to": "report_writer"}
        ],
...
class HaystackProblems:
    ...
    PIPELINE_INTEGRATION_GOOD = {
        ...
        "components": [
            ...
            {"name": "answer_generator", "type": "generator", "config": {"model": "gpt-3.5-turbo"}}
        ],
        "connections": [
...
class LangGraphProblems:
    ...
    GRAPH_EXECUTION_GOOD = {
        ...
        "nodes": [
            ...
            {"id": "process", "type": "action", "config": {"handler": "process_request"}},
            {"id": "approve", "type": "decision", "config": {"criteria": "business_rules"}}
        ],
        "edges": [
...
if __name__ == "__main__":
    ...
    for framework in ['autogen', 'langchain', 'crewai', 'llamaindex', 'haystack', 'langgraph', 'semantickernel']:
