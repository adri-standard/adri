...
All participants must follow our [Code of Conduct](code-of-conduct.md). We are committed to providing a welcoming and inclusive environment for everyone.
...
1. **Join the Conversation**: Introduce yourself in [Discussions](https://github.com/adri-ai/adri/discussions)
2. **Find an Issue**: Look for "good first issue" labels
3. **Attend Meetings**: Monthly community calls (first Tuesday, 16:00 UTC)
4. **Contribute**: See [Contributing Guide](standard-contributors/getting-started.md) for guidelines
...
- **Security Issues**: See [Security Policy](security.md) for reporting process
...
**Test coverage**: Verified by tests documented in [governance_test_coverage.md](test-coverage/governance_test_coverage.md)
