...
**Why this file exists**: Provides comprehensive documentation on the Validity dimension, which evaluates whether data adheres to required types, formats, and ranges, with emphasis on explicit communication to agents.

**Key responsibilities**:
- Explain how validity assessment works in ADRI
- Detail scoring components and their weights
- Document explicit vs. implicit metadata assessment
- Provide configuration options and examples
- Guide best practices for achieving high validity scores

**Test coverage**: This document's examples, claims, and features should be verified by tests documented in [validity_dimension_test_coverage.md](./test_coverage/validity_dimension_test_coverage.md)
